...
public class Map {
	...
	public Map(int width, int height, int chests, int trees) {
		...
		mapImg = new BufferedImage(width*squareSize, height*squareSize, BufferedImage.TYPE_INT_RGB);
		makeMap();
	}
	...
	public void draw(Graphics2D g2d) {
		...
		g2d.drawImage(this.mapImg,0,0,null);
	}
